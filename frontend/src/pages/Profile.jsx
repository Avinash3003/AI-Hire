...
import { User, Mail, Briefcase, Calendar, MapPin, Edit3 } from 'lucide-react';
        ...
        <div className="px-6 sm:px-10 pb-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold border-b border-white/5 pb-2">Contact Information</h3>
            ...
            <div className="space-y-6">
              <div className="p-5 rounded-xl border border-white/5 bg-dark-surface/40">
                <h3 className="text-sm font-semibold text-gray-300 mb-4 uppercase tracking-wider">Your Statistics</h3>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-gray-400">{user.role === 'student' ? 'Profile Completion' : 'Job Posting Quota'}</span>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-gray-400">{user.role === 'student' ? 'Applications Sent' : 'Active Candidates'}</span>
                      <span className="text-white font-medium">{user.role === 'student' ? '12' : '43'}</span>
                    </div>
                  </div>
                </div>
              </div>
